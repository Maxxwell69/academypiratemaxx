...
This repo ships the LMS from **[bemnet16/Learning-management-system](https://github.com/bemnet16/Learning-management-system)** (Next.js + Express). It is **not** the old Shogun/Frappe/Railway project.
